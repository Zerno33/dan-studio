-- Przy tworzeniu profilu skopiuj kod nauczyciela z Auth (signUp options.data.referred_by).
-- Inaczej ADMIN widzi nowego usera, a NAUCZYCIEL ma 0 — trigger handle_new_user nie zapisuje referred_by.
...
-- Dopnij już istniejących userów, jeśli Auth ma referred_by, a profil nie.
